...
namespace cym { namespace uix {
  ...
  bool CCanvas::init(CWindow* pParent, const SConfig& sConfig, int nHints) {
    log::dbg << "uix::CCanvas::init(CWindow*,SConfig&,int)::" << this << log::end;

...
namespace cym {
  void CVertexLayout::push(SElement&& element) {
    // SYS_LOG_NFO("cym::CVertexLayout::push(GLenum,c:"<< components << ",c:" << count << ",GLubyte)::" << this);
  ...
  void CVertexLayout::push(EAttribute eAttrib, GLenum type, GLcount components, GLcount count, GLubyte norm) {
    // SYS_LOG_NFO("cym::CVertexLayout::push(GLenum,c:"<< components << ",c:" << count << ",GLubyte)::" << this);
